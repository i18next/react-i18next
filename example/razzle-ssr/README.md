...
Built with [Vite SSR](https://vite.dev/guide/ssr) (react) and express.
...
- completely allows saveMissing feature of i18next -> added content will be pushed to server (`POST /locales/:lng/:ns`) and stored in `src/locales/{{lng}}/{{ns}}.missing.json`
