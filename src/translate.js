...
import { withContext, getDefaults, setDefaults, getI18n, setI18n } from './context';
...
export default function translate(namespaceArg, options = {}) {
  return function Wrapper(WrappedComponent) {
      ...
      constructor(props, context) {
        ...
        this.namespaces =
          typeof namespaceArg === 'function'
            ? namespaceArg(props)
            : namespaceArg || props.defaultNS || (this.i18n.options && this.i18n.options.defaultNS);
    ...
    const TranslateWithContext = withContext()(Translate);
    ...
    return hoistStatics(TranslateWithContext, WrappedComponent);
  };
}
